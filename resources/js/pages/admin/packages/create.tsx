        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-6 p-4 md:p-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-gray-900">Tambah Paket Baru</h1>
                        <p className="text-sm text-muted-foreground">Isi konfigurasi paket MLM baru.</p>
                    </div>
                </div>
                            ...
                            <CardContent className="grid gap-5">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="grid gap-2">
                                        <Label htmlFor="key">Key (unik, e.g. Silver)</Label>
                                        <Input
                                            id="key"
                                            value={data.key}
