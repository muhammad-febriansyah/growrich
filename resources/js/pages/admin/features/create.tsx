...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah Fitur', href: '/admin/features/create' },
];

const AVAILABLE_ICONS = [
    'Target', 'Zap', 'Trophy', 'ShieldCheck', 'Star', 'Users', 'DollarSign', 'Box', 'BarChart', 'Heart',
    'Smartphone', 'Globe', 'Lock', 'Gift', 'Clock', 'Award', 'CheckCircle', 'TrendingUp', 'Zap', 'Layers'
];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-6 p-4 md:p-6">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight text-gray-900">Tambah Fitur Unggulan</h1>
                </div>
                ...
                <form onSubmit={submit}>
                    <Card className="shadow-sm border-slate-200">
                        <CardHeader className="bg-slate-50/50 border-b">
                            ...
                            <CardDescription>Berikan detail tentang fitur unggulan yang akan ditampilkan.</CardDescription>
                        </CardHeader>
