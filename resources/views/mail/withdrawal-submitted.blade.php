...
<head>
    ...
    <title>Permintaan Penarikan Diterima</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:48px 48px 32px;">
                            ...
                            <p style="margin:0 0 8px;font-size:13px;color:#237A13;font-weight:600;text-transform:uppercase;letter-spacing:1px;">Permintaan Diterima</p>
                            ...
                            <p style="margin:0 0 24px;font-size:15px;color:#4b5563;line-height:1.7;">
                                Halo {{ $user->name }}, permintaan penarikan dana Anda telah berhasil dikirim dan sedang menunggu persetujuan admin. Berikut adalah detail permintaan Anda:
                            </p>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td style="padding:6px 0;">
                                                    <span style="font-size:13px;color:#6b7280;display:block;margin-bottom:2px;">Jumlah Penarikan</span>
                                            ...
                                            <tr>
                                                <td style="padding:6px 0;border-top:1px solid #d1fae5;">
                                                    <span style="font-size:13px;color:#6b7280;display:block;margin-bottom:2px;">Tanggal Pengajuan</span>
                                                    <span style="font-size:15px;color:#111827;font-weight:600;">{{ $withdrawal->created_at->format('d F Y, H:i') }} WIB</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:6px 0;border-top:1px solid #d1fae5;">
                                                    <span style="font-size:13px;color:#6b7280;display:block;margin-bottom:2px;">Status</span>
                                                    <span style="font-size:15px;color:#d97706;font-weight:600;">Menunggu Persetujuan</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <p style="margin:0 0 32px;font-size:15px;color:#4b5563;line-height:1.7;">
                                Anda akan mendapatkan notifikasi email kembali setelah permintaan ini diproses oleh admin. Pantau status penarikan melalui dashboard Anda.
                            </p>
