...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Buat Artikel Baru', href: '/admin/blog-posts/create' },
];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mx-auto max-w-5xl p-4 md:p-6 space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight text-gray-900">Buat Artikel Baru</h1>
                </div>
                            ...
                            <CardContent>
                                <div className="space-y-2">
                                    ...
                                    <RichEditor
                                        ...
                                        placeholder="Ringkasan ini akan muncul di daftar blog..."
                                    />
                                    <p className="text-xs text-muted-foreground italic text-right">Ringkasan singkat untuk menarik pembaca.</p>
                                </div>
                            </CardContent>
                        </Card>
                    </div>
                            ...
                            <CardContent className="space-y-4">
                                <div className="flex items-center justify-between rounded-lg border p-4">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-muted-foreground">Langsung publikasikan ke website.</p>
                                    </div>
                                    <Switch
                                    ...
                                    {previewUrl ? (
                                        ...
                                        <label className="flex flex-col items-center gap-2 cursor-pointer w-full h-full justify-center">
                                            ...
                                            <div className="text-center">
                                                <span className="text-sm font-semibold text-primary">Klik untuk upload</span>
                                                <p className="text-xs text-muted-foreground mt-1">PNG, JPG, JPEG (Maks. 2MB)</p>
                                            </div>
