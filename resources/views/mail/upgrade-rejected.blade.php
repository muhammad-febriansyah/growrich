                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:48px 48px 32px;">
                            ...
                            <p style="margin:0 0 8px;font-size:13px;color:#b91c1c;font-weight:600;text-transform:uppercase;letter-spacing:1px;">Upgrade Tidak Disetujui</p>
                            ...
                            <p style="margin:0 0 24px;font-size:15px;color:#4b5563;line-height:1.7;">
                                Permintaan upgrade paket Anda tidak dapat disetujui saat ini. Berikut adalah detail permintaan yang dimaksud:
                            </p>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td style="padding:6px 0;">
                                                    <span style="font-size:13px;color:#6b7280;display:block;margin-bottom:2px;">Paket Saat Ini</span>
                                            ...
                                            <tr>
                                                <td style="padding:6px 0;border-top:1px solid #fecaca;">
                                                    <span style="font-size:13px;color:#6b7280;display:block;margin-bottom:2px;">Paket yang Diminta</span>
                                                    <span style="font-size:15px;color:#111827;font-weight:600;">{{ $upgradeRequest->requested_package }}</span>
                                                </td>
                                            </tr>
                                            @if($upgradeRequest->notes)
                                            <tr>
                                                <td style="padding:6px 0;border-top:1px solid #fecaca;">
                                                    <span style="font-size:13px;color:#6b7280;display:block;margin-bottom:2px;">Catatan Admin</span>
                                                    <span style="font-size:15px;color:#111827;font-weight:600;">{{ $upgradeRequest->notes }}</span>
                                                </td>
                                            </tr>
                                            @endif
                                            <tr>
                            ...
                            <p style="margin:0 0 32px;font-size:15px;color:#4b5563;line-height:1.7;">
                                Jika Anda memiliki pertanyaan mengenai keputusan ini atau ingin mengajukan permintaan kembali, silakan hubungi tim dukungan kami atau kunjungi halaman upgrade paket.
                            </p>
