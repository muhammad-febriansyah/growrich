                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:48px 48px 32px;">
                            ...
                            <p style="margin:0 0 8px;font-size:13px;color:#237A13;font-weight:600;text-transform:uppercase;letter-spacing:1px;">Bonus Disetujui</p>
                            <h1 style="margin:0 0 24px;font-size:24px;font-weight:700;color:#111827;line-height:1.3;">
                                Selamat, {{ $user->name }}!
                            </h1>

                            <p style="margin:0 0 24px;font-size:15px;color:#4b5563;line-height:1.7;">
                                Bonus Anda telah disetujui oleh admin. Dana e-wallet telah dikreditkan ke saldo akun Anda dan siap digunakan.
                            </p>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td style="padding:6px 0;">
                                                    <span style="font-size:13px;color:#6b7280;display:block;margin-bottom:2px;">Jenis Bonus</span>
                                                    <span style="font-size:15px;color:#111827;font-weight:600;">{{ $bonus->bonus_type->label() }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:6px 0;border-top:1px solid #d1fae5;">
                                                    <span style="font-size:13px;color:#6b7280;display:block;margin-bottom:2px;">Total Bonus</span>
                                                    <span style="font-size:15px;color:#237A13;font-weight:700;">Rp {{ number_format($bonus->amount, 0, ',', '.') }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:6px 0;border-top:1px solid #d1fae5;">
                                                    <span style="font-size:13px;color:#6b7280;display:block;margin-bottom:2px;">Dikreditkan ke E-Wallet</span>
                                                    <span style="font-size:15px;color:#111827;font-weight:600;">Rp {{ number_format($bonus->ewallet_amount, 0, ',', '.') }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:6px 0;border-top:1px solid #d1fae5;">
                                                    <span style="font-size:13px;color:#6b7280;display:block;margin-bottom:2px;">Bonus Tunai</span>
                                                    <span style="font-size:15px;color:#111827;font-weight:600;">Rp {{ number_format($bonus->cash_amount, 0, ',', '.') }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:6px 0;border-top:1px solid #d1fae5;">
                                                    <span style="font-size:13px;color:#6b7280;display:block;margin-bottom:2px;">Tanggal Disetujui</span>
                                                    <span style="font-size:15px;color:#111827;font-weight:600;">{{ now()->format('d F Y') }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <p style="margin:0 0 32px;font-size:15px;color:#4b5563;line-height:1.7;">
                                Lihat riwayat bonus lengkap Anda melalui dashboard member.
                            </p>

                            <table cellpadding="0" cellspacing="0" border="0" style="margin-bottom:32px;">
                                <tr>
                                    <td style="background-color:#237A13;border-radius:6px;">
                                        <a href="{{ route('member.bonuses.index') }}"
