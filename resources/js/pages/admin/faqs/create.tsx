...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah FAQ', href: '/admin/faqs/create' },
];
...
export default function FaqCreate() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/admin/faqs', {
            onSuccess: () => toast.success('FAQ berhasil ditambahkan'),
        });
    };
            ...
            <div className="flex flex-col gap-6 p-4 md:p-6">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <div>
                            <h1 className="text-xl font-bold text-gray-900">Tambah FAQ Baru</h1>
                            <p className="text-sm text-muted-foreground">Isi pertanyaan dan jawaban untuk ditampilkan di halaman FAQ.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <CardContent className="grid gap-5">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    className="w-32"
                                />
                                <p className="text-xs text-muted-foreground">FAQ akan diurutkan berdasarkan angka ini (kecil ke besar).</p>
                            ...
                            <div className="flex items-center gap-3 rounded-lg border bg-muted/30 p-3">
                                ...
                                <Label htmlFor="is_published" className="cursor-pointer font-medium">
                                    ...
                                    <span className="ml-1 text-xs font-normal text-muted-foreground">
                                        (FAQ akan langsung terlihat oleh pengguna)
                                    </span>
                                </Label>
                            </div>
                        </CardContent>
