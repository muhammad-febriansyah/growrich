...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\RewardPointLedger>
 */
class RewardPointLedgerFactory extends Factory
{
    public function definition(): array
    {
        ...
        return [
            ...
            'reason' => fake()->randomElement(['registration', 'reward_deduct']),
            'reference_id' => null,
